...
**Current version: 2.8.0** — version numbers from upstream projects (BeatDrop, MilkDrop3, etc.) do not apply to MDropDX12.
...
* Self-bootstrapping exe — ships with one redistributable demo preset (`sb_tunnel.milk3`); add more packs via the [Resources Guide](docs/Resources.md)
