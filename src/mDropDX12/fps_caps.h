...
// What TESTING_MODE pins the primary to. 60 because that is what the
// cross-engine harness sets MD3 PRO's ini MaxFPS to; the two must agree or a
// frame-rate gap shows up as a brightness difference in every comparison.
static constexpr int kTestingModeFpsCap = 60;
