...
void AnnotationsWindow::DoBuildControls() {
    ...
    // Row 2: Import / Scan buttons
    {
        ...
        m_hBtnResetUse = CreateBtn(hw, L"Reset Use", IDC_MW_ANNOTWIN_RESETUSE,
                                   x + 2 * (btnW + 4), y, btnW + 20, lineH, hFont);
    }
    y += lineH + gap;
...
void AnnotationsWindow::LayoutControls() {
    ...
    if (m_hBtnResetUse) MoveWindow(m_hBtnResetUse, x + 2 * (btnW + 4), y, btnW + 20, lineH, TRUE);
    y += lineH + gap;
