...
// Render tunables (Visual window). Sliders + value readouts are generated from
// kRenderTunables in render_tunables.h, which owns the ID for each row.
#define IDC_MW_TUNABLE_0            2197  // Slider: render tunable 0 (Md3GlowStrength)
#define IDC_MW_TUNABLE_0_LABEL      2198  // Static: value readout for tunable 0
#define IDC_MW_TUNABLE_1            2199  // Slider: render tunable 1 (MartinRibCore)
#define IDC_MW_TUNABLE_1_LABEL      2200  // Static: value readout for tunable 1
#define IDC_MW_TUNABLE_2            2201  // Slider: render tunable 2 (MartinRibHalo)
#define IDC_MW_TUNABLE_2_LABEL      2202  // Static: value readout for tunable 2
#define IDC_MW_TUNABLE_RESET        2203  // Button: reset all render tunables to defaults
...
#define IDC_MW_ANNOTWIN_RESETUSE     9637  // Button: Reset play counts / times
