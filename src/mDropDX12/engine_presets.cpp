...
// ranked by correlation. See tools/milk2-probe/flipmap.py and
// docs/superpowers/specs/2026-08-18-milk2-blend-findings.md.
//
...
void Engine::ApplyMilk2BlendPattern() {
  ...
  if (ComputeMilk2BlendField(m_szMilk2Pattern, bandCoord, m_nMilk2Direction))
    return;
...
void Engine::RandomizeBlendPattern() {
  ...
  if (mixtype == 0) {
    ...
    if (m_bMilk2UseSavedRandoms) {
      // random_1 is the saved band; 2–5 seed the four plasma corners.
